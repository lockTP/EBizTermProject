 ...
 *
 * @author Hao Bai
 * This is the main class for the whole spider functionality. It can run independently as a main class (invoking its main() function)
 * or run as part of the web service (invoking its startSpider() function).
 */
